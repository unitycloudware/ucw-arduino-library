...
#include "UCW_REST32.h"


UCW_REST32::UCW_REST32(UCWConfig *config, const char *ssid, const char *pass) : UCW_REST(config) {
  _ssid = ssid;
  _pass = pass;

}

UCW_REST32::~UCW_REST32() {
;
}

void UCW_REST32::_connect() {
...
ucw_status_t UCW_REST32::networkStatus() {
  switch(WiFi.status()) {
    case WL_CONNECTED:
...
void UCW_REST32::printNetworkInfo() {
...
String UCW_REST32::connectionType() {
  return "esp32";
}

void UCW_REST32::printConnectionStatus() {
  UCW_LOG_PRINTLN();
