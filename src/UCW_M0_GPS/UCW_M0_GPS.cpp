...
UCW_M0_GPS::UCW_M0_GPS(){
analogReadResolution(12);
}

void UCW_M0_GPS::setConnectionMode() {
  if (isTokenValid){
      setupGPS();
      while (!Serial) {
...
void UCW_M0_GPS::printWifiStatus() {
  Serial.println();
...
void UCW_M0_GPS::sendData(String your_deviceID,String your_dataStreamName,String payload) {
...
void UCW_M0_GPS::readResponse(String http_header[50], String res_header ){
